...
/**
 * Referral Rule Condition model — extends AbstractModel for conditions tree support
 */
class ReferralRuleCondition extends AbstractModel
{
    /**
     ...
     * @param ReferralRuleCollection $resourceCollection
     * @param array $data
    ...
    public function __construct(
        ...
        ReferralRuleResource $resource,
        ReferralRuleCollection $resourceCollection,
        array $data = [],
