...
namespace Meetanshi\RewardPoints\Model\ResourceModel\Rule\CartRule;
...
/**
 * Reward Points Cart Rule Collection
 */
class Collection extends AbstractCollection
{
    ...
    protected function _construct(): void
    {
        ...
        $this->_init(CartRule::class, CartRuleResource::class);
    }
