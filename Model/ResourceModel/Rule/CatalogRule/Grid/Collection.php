...
namespace Meetanshi\RewardPoints\Model\ResourceModel\Rule\CatalogRule\Grid;
...
use Meetanshi\RewardPoints\Model\ResourceModel\Rule\CatalogRule\Collection as CatalogRuleCollection;
use Psr\Log\LoggerInterface;
use Magento\Framework\DB\Expr as Zend_Db_Expr;

/**
 * Catalog Rule Grid Collection
 *
 * Extends the base catalog rule collection and joins websites and customer groups
 * for the admin grid display.
 */
class Collection extends CatalogRuleCollection implements SearchResultInterface
{
    /**
    ...
    public function addFieldToFilter($field, $condition = null)
    {
        if ($field === 'websites') {
            ...
            $websiteSelect = $this->getConnection()->select()
                ...
                ->where('fw.rule_type = ?', 'catalog_earning')
        ...
        if ($field === 'customer_groups') {
            ...
            $groupSelect = $this->getConnection()->select()
                ...
                ->where('fg.rule_type = ?', 'catalog_earning')
