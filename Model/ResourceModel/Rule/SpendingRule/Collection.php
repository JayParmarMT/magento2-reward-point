...
namespace Meetanshi\RewardPoints\Model\ResourceModel\Rule\SpendingRule;
...
/**
 * Reward Points Spending Rule Collection
 */
class Collection extends AbstractCollection
{
    ...
    protected function _construct(): void
    {
        ...
        /**
         * Spending Rule Resource.
         */
        
        $this->_init(SpendingRule::class, SpendingRuleResource::class);
    }
