...
namespace Meetanshi\RewardPoints\Model\ResourceModel\Rule\ReferralRule\Grid;
...
use Meetanshi\RewardPoints\Model\ResourceModel\Rule\ReferralRule\Collection as ReferralRuleCollection;
use Psr\Log\LoggerInterface;
use Magento\Framework\DB\Expr as Zend_Db_Expr;

/**
 * Referral Rule Grid Collection
 *
 * Extends the base referral rule collection and joins websites and customer groups
 * for the admin grid display.
 */
class Collection extends ReferralRuleCollection implements SearchResultInterface
{
    /**
