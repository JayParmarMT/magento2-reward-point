...
class NewConditionHtml extends Action implements HttpGetActionInterface, HttpPostActionInterface
{
     ...
     * @param CatalogRuleConditionFactory $catalogRuleConditionFactory
     */
    public function __construct(
        Context $context,
        private readonly CatalogRuleConditionFactory $catalogRuleConditionFactory,
    ) {
    ...
    public function execute(): void
    {
        ...
        $rule = $this->catalogRuleConditionFactory->create();
