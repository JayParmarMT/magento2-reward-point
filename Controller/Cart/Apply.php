...
class Apply implements HttpPostActionInterface
{
    ...
    public function execute(): ResultInterface
    {
        ...
        try {
            ...
            // Use customer ID from the quote to avoid session singleton timing issues
            ...
            if (!$customerId) {
                return $result->setData([
                    'success' => false,
                    'message' => __('Unable to identify customer. Please refresh and try again.'),
                ]);
            }
            ...
            $this->logger->error('RewardPoints: error applying points to cart', ['exception' => $e]);
