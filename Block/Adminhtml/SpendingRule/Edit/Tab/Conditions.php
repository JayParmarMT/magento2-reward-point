...
namespace Meetanshi\RewardPoints\Block\Adminhtml\SpendingRule\Edit\Tab;
...
/**
 * Conditions tab block for Adminhtml form
 */
class Conditions extends Generic implements TabInterface
{
     ...
     * @param SpendingRuleConditionFactory $ruleConditionFactory
     * @param array $data
     */
    public function __construct(
        ...
        private readonly SpendingRuleConditionFactory $ruleConditionFactory,
        array $data = [],
    ) {
    ...
    protected function _prepareForm()
    {
        ...
        $formName             = 'meetanshi_rewardpoints_spending_rule_form';
        $conditionsFieldSetId = $model->getConditionsFieldSetId($formName);

        $newChildUrl = $this->getUrl(
            'meetanshi_rewardpoints/spendingrule/newConditionHtml/form/' . $conditionsFieldSetId,
        ...
        $form->setHtmlIdPrefix('spending_rule_');

        $fieldset = $form->addFieldset(
            $conditionsFieldSetId,
            ['legend' => __('Apply the rule only if the following conditions are met (leave blank for all carts).')],
