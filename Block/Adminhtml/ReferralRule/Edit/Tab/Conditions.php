...
namespace Meetanshi\RewardPoints\Block\Adminhtml\ReferralRule\Edit\Tab;
...
class Conditions extends Generic implements TabInterface
{
     ...
     * @param ReferralRuleConditionFactory $ruleConditionFactory
     * @param array $data
     */
    public function __construct(
        ...
        private readonly ReferralRuleConditionFactory $ruleConditionFactory,
        array $data = [],
    ) {
    ...
    protected function _prepareForm()
    {
        ...
        $formName             = 'meetanshi_rewardpoints_referral_rule_form';
        $conditionsFieldSetId = $model->getConditionsFieldSetId($formName);

        $newChildUrl = $this->getUrl(
            'meetanshi_rewardpoints/referralrule/newConditionHtml/form/' . $conditionsFieldSetId,
        ...
        $form->setHtmlIdPrefix('referral_rule_');
