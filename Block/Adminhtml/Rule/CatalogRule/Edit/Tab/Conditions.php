...
namespace Meetanshi\RewardPoints\Block\Adminhtml\Rule\CatalogRule\Edit\Tab;
...
class Conditions extends Generic implements TabInterface
{
     ...
     * @param CatalogRuleConditionFactory $ruleConditionFactory
     * @param array $data
     */
    public function __construct(
        ...
        private readonly CatalogRuleConditionFactory $ruleConditionFactory,
        array $data = [],
    ) {
    ...
    protected function _prepareForm()
    {
        ...
        $formName             = 'meetanshi_rewardpoints_catalog_rule_form';
        $conditionsFieldSetId = $model->getConditionsFieldSetId($formName);

        $newChildUrl = $this->getUrl(
            'meetanshi_rewardpoints/catalogrule/newConditionHtml/form/' . $conditionsFieldSetId,
        ...
        $form->setHtmlIdPrefix('catalog_rule_');
