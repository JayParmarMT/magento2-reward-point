...
namespace Meetanshi\RewardPoints\Block\Adminhtml\Rule\CartRule\Edit\Tab;
...
class Conditions extends Generic implements TabInterface
{
     ...
     * @param CartRuleConditionFactory $ruleConditionFactory
     * @param array $data
     */
    public function __construct(
        ...
        private readonly CartRuleConditionFactory $ruleConditionFactory,
        array $data = [],
    ) {
    ...
    protected function _prepareForm()
    {
        ...
        $formName             = 'meetanshi_rewardpoints_cart_rule_form';
        $conditionsFieldSetId = $model->getConditionsFieldSetId($formName);

        $newChildUrl = $this->getUrl(
            'meetanshi_rewardpoints/cartrule/newConditionHtml/form/' . $conditionsFieldSetId,
        ...
        $fieldset = $form->addFieldset(
            ...
            ['legend' => __('Apply the rule only if the following conditions are met (leave blank for all orders).')],
